  ...
  <div class="container">
    ...
    <div class="write-form-wrap reveal" style="max-width: 750px;">
      <div class="write-form-card">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="auth-form write-form">
          ...
          <div class="form-grid" style="grid-template-columns: 1fr 1fr;">
            ...
            <div class="form-group" style="grid-column: span 2;">
              ...
              <select name="bo_table" id="bo_table" class="form-input form-select">
                <option value="notice">공지사항 (Notice)</option>
                <option value="cases">치료 사례 (Treatment Cases)</option>
            ...
            <div class="form-group" id="notice_option_wrap" style="grid-column: span 2; display: flex; flex-direction: row; align-items: center; gap: 8px;">
              <label class="remember-me">
                <input type="checkbox" name="notice_pinned" id="notice_pinned" value="1">
            ...
            <div class="form-group" id="case_stats_wrap" style="grid-column: span 2; display: none; background: var(--c-bg-cream); padding: 24px; border-radius: 8px; border: 1px solid var(--c-border); margin-bottom: 8px;">
              ...
              <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                <div class="form-group">
                  ...
                  <input type="text" name="wr_1" id="wr_1" class="form-input" placeholder="예: 치료 기간, 평가 항목" value="치료 기간">
                </div>
                <div class="form-group">
                  <label for="wr_2" class="form-label">지표 1 수치/값 (wr_2)</label>
                  <input type="text" name="wr_2" id="wr_2" class="form-input" placeholder="예: 24개월, 7종">
                </div>
                <div class="form-group">
                  <label for="wr_3" class="form-label">지표 2 항목명 (wr_3)</label>
                  <input type="text" name="wr_3" id="wr_3" class="form-input" placeholder="예: 성장 결과, 관리 플랜" value="성장 결과">
                </div>
                <div class="form-group">
                  <label for="wr_4" class="form-label">지표 2 수치/값 (wr_4)</label>
                  <input type="text" name="wr_4" id="wr_4" class="form-input" placeholder="예: +18.5cm, 수립 완료">
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" name="wr_name" id="wr_name" class="form-input" value="관리자" required>
            </div>
            ...
            <div class="form-group" style="grid-column: span 2;">
              ...
              <input type="text" name="wr_subject" id="wr_subject" class="form-input" placeholder="글 제목을 입력하세요" required>
            </div>

            <!-- 7. 글 내용 (텍스트 에디터) -->
            <div class="form-group" style="grid-column: span 2;">
              <label for="wr_content" class="form-label">내용</label>
              <textarea name="wr_content" id="wr_content" class="form-input form-textarea" placeholder="치료 과정 또는 공지 내용을 입력하세요." required></textarea>
            </div>
