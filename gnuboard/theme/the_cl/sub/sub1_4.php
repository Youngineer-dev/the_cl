...
<div class="sub-intro-text">
  ...
  <h2 class="section-title reveal reveal-delay-1">
    심리적 안정감을 제공하는 인테리어,<br class="pc-only">
...
<div class="space-gallery" style="margin-top: 60px;">
  <div class="space-gallery-item reveal">
    <img src="<?php echo $G5_URL; ?>/img/interior.png" alt="잠실 삼성더클성장의원 소아청소년과 편안한 대기 라운지 인테리어">
  ...
  <div class="space-gallery-item reveal reveal-delay-1">
    <img src="<?php echo $G5_URL; ?>/img/hero.png" alt="송파 삼성더클성장의원 소아내분비 전문의 1대1 성장 상담 및 진료실">
    <div class="gallery-caption" style="opacity: 1; transform: translateY(0); background: rgba(0,0,0,0.55);">
  ...
  <div class="space-gallery-item reveal reveal-delay-2">
    <img src="<?php echo $G5_URL; ?>/img/interior.png" alt="삼성더클성장의원 골연령 뼈나이 분석용 저선량 X-ray 기기를 보유한 성장 정밀 검사실">
    <div class="gallery-caption" style="opacity: 1; transform: translateY(0); background: rgba(0,0,0,0.55);">
  ...
  <div class="space-gallery-item reveal reveal-delay-3" style="margin-top: 20px;">
    <img src="<?php echo $G5_URL; ?>/img/hero.png" alt="잠실 삼성더클성장의원 어린이 및 청소년 프라이빗 영양 수액 치료실">
    <div class="gallery-caption" style="opacity: 1; transform: translateY(0); background: rgba(0,0,0,0.55);">
  ...
  <div class="space-gallery-item reveal reveal-delay-4" style="margin-top: 20px;">
    <img src="<?php echo $G5_URL; ?>/img/interior.png" alt="삼성더클성장의원 신장 체중 및 인바디 예상키 측정을 위한 신체 계측실">
    <div class="gallery-caption" style="opacity: 1; transform: translateY(0); background: rgba(0,0,0,0.55);">
  ...
  <div class="space-gallery-item reveal reveal-delay-5" style="margin-top: 20px;">
    <img src="<?php echo $G5_URL; ?>/img/hero.png" alt="송파구 삼성더클성장의원 내원 어린이를 위한 감성 교구 및 키즈 스페이스 놀이방">
    <div class="gallery-caption" style="opacity: 1; transform: translateY(0); background: rgba(0,0,0,0.55);">
