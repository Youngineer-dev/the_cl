      ...
      <div class="ed-split__text">
        ...
        <div class="ed-split__body" style="margin-top: 24px;">
          <p class="lead">
            ...
            <span style="font-size: 13px; color: var(--c-text-light); display: inline-block; margin-top: 12px; opacity: 0.85; font-weight: 400;">※ 저신장 기준 및 성장호르몬 치료 급여 기준은 건강보험심사평가원 및 대한소아내분비학회 표준 지침을 따릅니다.</span>
          </p>
        </div>
      </div>
      <div class="ed-collage reveal reveal-delay-2">
        <img src="<?php echo $G5_URL; ?>/img/hero.png" alt="잠실 삼성더클성장의원 소아내분비 전문의의 저신장 정밀 성장 발달 진단" class="ed-collage__main">
        <img src="<?php echo $G5_URL; ?>/img/interior.png" alt="송파구 삼성더클성장의원 쾌적한 소아청소년 성장 클리닉 공간" class="ed-collage__sub">
      </div>
    </section>
