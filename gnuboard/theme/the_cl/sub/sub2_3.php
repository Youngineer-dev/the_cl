  ...
  <div class="container">
    ...
    <section class="ed-split reveal">
      ...
      <div class="ed-collage reveal reveal-delay-2">
        <img src="<?php echo $G5_URL; ?>/img/prog_precocious_main.jpg" alt="잠실 삼성더클성장의원 소아내분비 전문의의 성조숙증 정밀 호르몬 및 뼈나이 진단" class="ed-collage__main">
        <img src="<?php echo $G5_URL; ?>/img/prog_precocious_sub.jpg" alt="송파구 삼성더클성장의원 성조숙증 진단용 성장 클리닉 공간" class="ed-collage__sub">
      </div>
    </section>
      ...
      <div class="ed-steps" style="margin-top: 30px;">
        ...
        <div class="ed-step reveal reveal-delay-5">
          ...
          <div class="ed-step__body">
            ...
            <p class="ed-step__desc">
              여아에서는 자궁·난소 상태를 확인하기 위해 필요 시 유방, 골반 초음파를 시행할 수 있습니다.
            </p>
          </div>
        </div>
        <!-- Step 7 -->
