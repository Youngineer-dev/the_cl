...
$page_schema_json = [
    ...
    "mainEntity" => [
        [
            "@type" => "Question",
            "name" => "성장 호르몬 주사 요법은 부작용이 없나요? 안심해도 될까요?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "성장 호르몬 치료제는 지난 수십 년 동안 전 세계 소아들을 대상으로 안전성과 효능이 정밀하게 입증된 약제입니다. 일시적인 관절통, 척추 휘어짐 등 빈도 낮은 부작용이 있을 수 있으나 소아 내분비 세부전문의의 체계적인 용량 조절과 분기별 혈액 검사를 통해 예방 및 안심 관리가 충분히 가능합니다."
            ]
        ],
        [
            "@type" => "Question",
            "name" => "주사 치료는 언제 시작하는 것이 가장 높은 효율을 내나요?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "가장 최선의 시기는 사춘기가 본격적으로 오기 전(여아 만 9세 이전, 남아 만 10세 이전)입니다. 뼈 나이가 어릴수록 투여 기간 대비 키 성장의 절대값이 훨씬 큽니다. 따라서 초등학교 저학년 전후로 정밀 성장 평가를 최소 1회 받아보시길 강력 권장합니다."
            ]
        ],
        [
            "@type" => "Question",
            "name" => "비만 아동도 성장 주사를 맞아야 효과를 보나요?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "비만 아동은 호르몬 효율성이 낮을 수 있으므로 주사 투여 전에 체성분 관리와 체지방률 감소 식단을 선행하여 지방 세포에서 분비되는 비정상 에스트로겐을 제어한 뒤, 의학적 소견에 맞춰 성장판 자극과 호르몬 활성 치료를 단계적으로 결합하는 것이 더 효과적입니다."
            ]
        ],
        [
            "@type" => "Question",
            "name" => "비급여 진료비는 실손 의료보험(실비) 혜택이 적용되나요?",
            "acceptedAnswer" => [
                "@type" => "Answer",
                "text" => "저신장증 질환 분류 코드(E34.3 등) 기준에 부합하거나 병리적 성장호르몬 결핍 진단을 받아 치료하는 질환 목적의 경우 실손보험 혜택 적용 대상이 될 수 있습니다. 단순 외형적 키 성장(미용) 목적 수가는 실비 환급 대상에서 제외되므로 정밀 검사 결과를 토대로 원장님과 상의하시기 바랍니다."
            ]
        ]
    ]
];
