...
<div class="contact-inner" style="margin-top: 60px;">
  <div class="contact-left reveal">
    ...
    <div class="map-buttons" style="margin-top: 14px;">
      ...
      <a href="#" onclick="goToKakaoMap(event)" class="map-btn" style="flex: 1; text-align: center; font-weight: 600; display: inline-flex; align-items: center; justify-content: center; gap: 6px;">
