    ...
    <section class="ed-split reveal">
      <div class="ed-split__text">
        ...
        <h2 class="ed-split__title ed-split__title--simple">
          <strong>살이 안 찌는 아이</strong>, <span class="br-all" aria-hidden="true"></span> 원인에 맞는 영양 평가가 필요합니다
        </h2>
      ...
      <div class="ed-collage reveal reveal-delay-2">
        <img src="<?php echo $G5_URL; ?>/img/prog_underweight_main.jpg" alt="잠실 삼성더클성장의원 소아내분비 전문의의 소아 저체중 원인 규명 및 영양 상태 정밀 진단" class="ed-collage__main">
        <img src="<?php echo $G5_URL; ?>/img/prog_underweight_sub.jpg" alt="송파구 삼성더클성장의원 소아 저체중 케어용 성장 클리닉 공간" class="ed-collage__sub">
      </div>
    </section>
