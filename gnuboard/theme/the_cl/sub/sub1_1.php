...
<main class="sub-main">
  <div class="container">
    <div class="ph-wrap">
      ...
      <!-- 대표 이미지 프레임 -->
      <img src="<?php echo $G5_URL; ?>/img/about_intro.jpg" alt="송파 잠실 삼성더클성장의원 인테리어 전경" class="sub11_sect1_img reveal reveal-delay-1">
      ...
      <div class="sub11_sect2_contWrap" style="gap: 120px; padding: 40px 0 60px;">
        ...
        <article class="sub11_sect2_item item1 imgRight reveal">
          ...
          <div class="imgBox">
            <img src="<?php echo $G5_URL; ?>/img/about_care_diagnosis.jpg" alt="소아내분비 전문의의 세심한 성장 발달 및 예상키 정밀 진단 과정" class="item_img">
        ...
        <article class="sub11_sect2_item item2 imgLeft reveal">
          <div class="imgBox">
            <img src="<?php echo $G5_URL; ?>/img/about_lifestyle.jpg" alt="성장기 아동의 일상 습관과 예상 키 성장을 위한 일대일 라이프스타일 동행" class="item_img">
        ...
        <div class="ph-special-grid">
          ...
          <article class="ph-special-item">
            ...
            <div class="ph-special-body">
              ...
              <p>
                뼈나이는 판독 경험과 평가 방식에 따라 차이가 날 수 있습니다.<br class="pc-only">
                수만 건 이상의 뼈나이 판독 경험을 가진 소아내분비 전문의가 다각도(GP, TW3 method)로 직접 판독하고 추가로 최신 AI 기능을 도입한 추가 분석을 함께 활용하여 판독 편차를 줄이고 성장 잠재력을 보다 정밀하게 분석합니다.
              </p>
            </div>
          </article>
