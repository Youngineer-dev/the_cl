  ...
  <footer class="site-footer">
    <div class="container">
      <div class="footer-links">
        ...
        <span style="color: rgba(255, 255, 255, 0.35);">|</span>
        <a href="<?php echo $G5_URL; ?>/sub/uninsured.php" style="color: rgba(255, 255, 255, 0.65); text-decoration: none;">비급여항목</a>
      </div>
      <div class="footer-inner">
        <div class="footer-info">
          ...
          <span style="margin-top: 4px; display: inline-block;">COPYRIGHT © <?php echo date('Y'); ?> 삼성더클성장의원. ALL RIGHTS RESERVED<a href="<?php echo G5_BBS_URL; ?>/login.php" style="color: inherit; text-decoration: none; cursor: default;">.</a></span>
        </div>
      </div>
    </div>
  </footer>
